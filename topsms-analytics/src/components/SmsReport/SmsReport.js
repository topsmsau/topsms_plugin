...
export class SmsReport extends ReactComponent {
    ...
    countByStatus(messages, status) {
        ...
        return messages.filter((message) => message && message.status === status).length;
    }
            ...
            return (
                ...
                <SmsTable
                    ...
                    pagination={{
                        ...
                        currentPage: this.state.currentPage, // Use the state value directly
                        perPage: this.state.perPage, // Use the state value directly
                }}
